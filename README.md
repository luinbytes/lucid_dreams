...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `luinbytes`, `lucid_dreams`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `lucid dreams`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/luinbytes/lucid_dreams.git
   ```
...
See the [open issues](https://github.com/luinbytes/lucid_dreams/issues) for a full list of proposed features (and known issues).
